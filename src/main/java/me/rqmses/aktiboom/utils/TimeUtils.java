...
public class TimeUtils {
    ...
    public static int hoursSinceMeeting() {
        return Math.toIntExact(Duration.between(dateOfMeeting(), LocalDateTime.now()).toHours());
    }

    public static LocalDateTime dateOfMeeting() {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd.MM.yyyy HH:mm");
        String meeting = null;
        try {
            meeting = SheetUtils.getValueRange("Equiplog", "G15:J17").getValues().get(0).get(0).toString();
