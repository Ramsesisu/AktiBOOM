...
public class LocationUtils {
    public static List<String> getLocs() {
        return Arrays.asList("Stadthalle", "Uranberg", "W\u00fcrfelpark", "261", "248", "KF-Kran", "LU-Kran",
                ...
                "382", "Metzgerei", "Las-Unicas", "CT-Shop", "Mileu", "Ballas", "SH", "KH", "Uran", "523", "278", "280", "121", "Brauerei");
    }
