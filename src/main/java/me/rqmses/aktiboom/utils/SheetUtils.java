...
public class SheetUtils {
    ...
    @SuppressWarnings("UnnecessaryLocalVariable")
    public static void setLine(String sheet, String range, String[] args) throws IOException {
        Object[] values = args;
        sheetsService.spreadsheets().values()
    ...
    public static boolean setRank(String name, String rank) {
        try {
            ...
            setLine(InformationType.RANKS.getSheet(), "A"+index+":A"+index, new String[]{rank});
        } catch (IOException e) {
            return false;
        }
        return true;
    ...
    public static boolean setSECRank(String name, String rank) {
        try {
            ...
            setLine(InformationType.SECRANKS.getSheet(), "I"+index+":I"+index, new String[]{rank});
        } catch (IOException e) {
            return false;
        }
        return true;
