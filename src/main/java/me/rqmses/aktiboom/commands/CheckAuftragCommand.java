...
public class CheckAuftragCommand extends CommandBase implements IClientCommand {
    ...
    public String getUsage(ICommandSender sender) {
        return "/checkauftrag [Name]";
    }

    @Override
    @Nonnull
    public List<String> getAliases() {
        return Arrays.asList("checklieferung", "checkdelivery");
    }
