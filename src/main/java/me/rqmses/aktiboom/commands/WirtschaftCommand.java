...
public class WirtschaftCommand extends CommandBase implements IClientCommand {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) {
        new Thread(() -> {
            ...
            try {
                wins = SheetUtils.getValueRange("Win/Lose Statistik", "C6:D64").getValues();
                loses = SheetUtils.getValueRange("Win/Lose Statistik", "E6:F64").getValues();
            ...
            int spent = equipdifference - wagesspent;
