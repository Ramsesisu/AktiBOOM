            ...
            if (args.length > 1) {
                if (RANK >= 5) {
                    try {
                        ...
                        SheetUtils.setLine("\u00dcbersicht", "A" + index + ":Q" + index + "", new String[]{"0", args[0], "=IFNA(IFS(A" + index + "=6; WAHR; A" + index + "=5; WAHR; UND(A" + index + "=4;O" + index + ">=12000); WAHR; UND(A" + index + "=3;M" + index + ">=6;O" + index + ">=10000;P" + index + ">=1; Q" + index + ">=3); WAHR; UND(A" + index + "=2;M" + index + ">=5;O" + index + ">=8000;P" + index + ">=1; Q" + index + ">=3); WAHR; UND(A" + index + "=1;M" + index + ">=5;O" + index + ">=6000; Q" + index + ">=3); WAHR; UND(A" + index + "=0;M" + index + ">=4;O" + index + ">=4000; Q" + index + ">=3); WAHR); FALSCH)", "=" + args[0] + "!C6", "=" + args[0] + "!C7", "=" + args[0] + "!C9", "=" + args[0] + "!C10", "=" + args[0] + "!C11", "=" + args[0] + "!C8", "=" + args[0] + "!C13", "=" + args[0] + "!C12", "=" + args[0] + "!C14", "=SUMME(D" + index + ":L" + index + ")", "=" + args[0] + "!H13", "=" + args[0] + "!B18", "=" + args[0] + "!B24", "=" + args[0] + "!B27"});

                        SheetUtils.addValues("Equiplog", "C36:E60", new String[]{args[0], args[1]});
                        SheetUtils.setLine("Equiplog", "B" + index + ":C" + index, new String[]{args[0], "=" + args[0] + "!H13"});
                        SheetUtils.addValues("Equiplog", "C977:D1000", new String[]{args[0], "0"});
                    } catch (IOException e) {
