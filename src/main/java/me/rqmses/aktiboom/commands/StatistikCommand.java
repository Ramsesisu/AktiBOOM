                ...
                if (args.length > 1) {
                    if (RANK >= 4) {
                        if (args[0].equalsIgnoreCase("win")) {
                            try {
                                SheetUtils.addValues("Win/Lose Statistik", "C6:C64", new String[]{args[1] + " (" + new SimpleDateFormat("dd.MM").format(new Date()) + ")"});
                        ...
                        if (args[0].equalsIgnoreCase("lose")) {
                            try {
                                SheetUtils.addValues("Win/Lose Statistik", "E6:E64", new String[]{args[1] + " (" + new SimpleDateFormat("dd.MM").format(new Date()) + ")"});
