    ...
    public List<String> getTabCompletions(@Nonnull MinecraftServer server, @Nonnull ICommandSender sender, @Nonnull String[] args, @Nullable BlockPos targetPos) {
        ...
        if (args.length == 4) {
            if (args[0].equalsIgnoreCase("add")) {
                targets = Collections.singletonList("3750");
            }
        }
                    ...
                    case "add":
                        if (args.length > 2) {
                            ...
                            try {
                                ...
                                player.sendChatMessage("/f %INFO% :&6" + player.getName() + "&e hat eine Autobombe f\u00fcr &6&l" + args[1] + "&e eingetragen.");
                            } catch (IOException e) {
                    ...
                    case "done":
                        if (args.length > 1) {
                            try {
                                ...
                                player.sendChatMessage("/f %INFO% :&6" + player.getName() + "&e hat die Autobombe f\u00fcr &6&l" + args[1] + "&e platziert.");
                    ...
                    case "rename":
                        if (args.length > 2) {
                            try {
                                ...
                                SheetUtils.setLine("Auftr\u00e4ge", "R" + line, new String[]{args[2]});
