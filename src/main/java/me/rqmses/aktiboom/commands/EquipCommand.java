                        ...
                        if (success) {
                            if (finalDiscount != 0) {
                                try {
                                    ...
                                    SheetUtils.setValues(InformationType.DISCOUNT.getSheet(), InformationType.DISCOUNT.getRange(), new String[]{String.valueOf(Integer.parseInt(stringdiscount) + finalDiscount)});
