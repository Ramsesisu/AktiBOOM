...
public class LeitfadenCommand extends CommandBase implements IClientCommand {
    ...
    private static void commands() {
        ...
        command("/drohungen");
        description("Gibt eine Liste aktueller Sprengg\u00fcrteldrohungen aus.");
        command("/equip");
        ...
        command("/refresh");
        description("L\u00e4dt Daten aus dem Aktivit\u00e4tsnachweis neu.");
        ...
        command("/sprengg\u00fcrteldrohung");
        description("F\u00fcgt eine Sprengg\u00fcrteldrohung zur Liste hinzu oder entfernt.");
        command("/statistik");
