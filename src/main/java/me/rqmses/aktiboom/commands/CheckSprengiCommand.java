        ...
        new Thread(() -> {
            ...
            if (args.length > 0) {
                ...
                try {
                    ...
                    player.sendMessage(new TextComponentString("  " + TextFormatting.GOLD + list.get(1).toString() + TextFormatting.DARK_GRAY + " | " + TextFormatting.YELLOW + list.get(3).toString() + TextFormatting.GRAY + " ab " + list.get(4) + TextFormatting.DARK_GRAY + " | " + TextFormatting.DARK_GRAY + list.get(2).toString() + " (" + list.get(0).toString() + ")"));
                } catch (IOException e) {
                    player.sendMessage(new TextComponentString(PREFIX + "Der Spieler hat keinen offenen Sprengg\u00fcrtelauftrag."));
                }
            } else {
